  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 max-w-7xl mx-auto w-full px-4 py-6">
        ...
        <button
          className="lg:hidden mb-4 btn-secondary text-xs w-full"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
              ...
              <div className="space-y-3">
                {schemes.map(s => (
                  <div key={s.id}
                    ...
                    {/* On mobile, show apply button inline when selected */}
                    {selected?.id === s.id && (
                      <button
          ...
          {/* Right: Guidelines + Scheme Detail */}
          <div className="lg:col-span-1 flex flex-col gap-4">
            ...
            {selected && (
              <div className="card border-t-4 border-secondary hidden lg:block">
