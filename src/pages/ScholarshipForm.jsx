          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <section>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div><label className="form-label">Aadhar Number *</label><input className="form-input" maxLength={12} value={form.aadhar} onChange={e => set('aadhar', e.target.value)} required /></div>
                <div>
                ...
                <div><label className="form-label">Community / Category *</label><input className="form-input" placeholder="SC / ST / OBC / General" value={form.community} onChange={e => set('community', e.target.value)} required /></div>
                <div><label className="form-label">Father's Name *</label><input className="form-input" value={form.fatherName} onChange={e => set('fatherName', e.target.value)} required /></div>
                <div><label className="form-label">Mother's Name *</label><input className="form-input" value={form.motherName} onChange={e => set('motherName', e.target.value)} required /></div>
                <div><label className="form-label">Family Annual Income (₹) *</label><input type="number" className="form-input" value={form.annualIncome} onChange={e => set('annualIncome', e.target.value)} required /></div>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div><label className="form-label">Class Start Date *</label><input type="date" className="form-input" value={form.classStartDate} onChange={e => set('classStartDate', e.target.value)} required /></div>
                <div><label className="form-label">University / Board Name *</label><input className="form-input" value={form.universityBoard} onChange={e => set('universityBoard', e.target.value)} required /></div>
                <div><label className="form-label">Previous Class / Course</label><input className="form-input" value={form.prevClass} onChange={e => set('prevClass', e.target.value)} /></div>
                <div><label className="form-label">Previous Passing Year</label><input className="form-input" maxLength={4} value={form.prevPassYear} onChange={e => set('prevPassYear', e.target.value)} /></div>
                <div><label className="form-label">Previous Class %</label><input type="number" className="form-input" max={100} value={form.prevClassPercent} onChange={e => set('prevClassPercent', e.target.value)} /></div>
              </div>
            </section>
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              ...
              <button type="button" className="btn-secondary w-full sm:w-auto px-10" onClick={() => navigate('/dashboard/student')}>Cancel</button>
            </div>
          </form>
        </div>
      </main>
